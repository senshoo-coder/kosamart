...
export const STORES: Store[] = [
  ...
  },
  {
    ...
    deliveryFee: 0,
    accentColor: '#F97316',
    subcategories: ['오리지널', '스페셜', '사이드'],
    products: [
      { id: 'ck-fried', name: '후라이드', description: '전통 물반죽을 이용한 치킨으로 튀김옷이 얇아 바삭하고 속은 촉촉한 치킨', price: 18000, unit: '마리', emoji: '🍗', subcategory: '오리지널', isAvailable: true, isPopular: true },
      { id: 'ck-seasoned', name: '양념치킨', description: '신선한 20여가지 재료들이 잘 조화된 매콤달콤한 페리카나의 대표 치킨', price: 20000, unit: '마리', emoji: '🍗', subcategory: '오리지널', isAvailable: true, isPopular: true },
      { id: 'ck-halfhalf', name: '반반치킨', description: '전통 후라이드와 매콤달콤한 양념치킨을 동시에 즐길 수 있는 베스트 메뉴', price: 20000, unit: '마리', emoji: '🍗', subcategory: '오리지널', isAvailable: true },
      { id: 'ck-spicy', name: '매운양념치킨', description: '인위적이고 자극적인 매운맛이 아닌 맛있게 매운맛으로 페리카나에서 가장 매운 치킨', price: 21000, unit: '마리', emoji: '🌶️', subcategory: '오리지널', isAvailable: true },
      { id: 'ck-garlic', name: '마늘치킨', description: '국내산 마늘을 직접 갈아 만든 치킨으로 한국인의 입맛에 잘 맞는 치킨', price: 21000, unit: '마리', emoji: '🧄', subcategory: '오리지널', isAvailable: true },
      { id: 'ck-soysauce', name: '간장치킨', description: '간장, 올리고당, 마늘, 굴엑기스 등으로 맛을 내 먹어도 먹어도 질리지 않는 깔끔한 치킨', price: 21000, unit: '마리', emoji: '🍗', subcategory: '오리지널', isAvailable: true },
      { id: 'ck-greenonion', name: '파닭치킨', description: '새콤달콤 톡 쏘는 소스와 신선한 파채를 경험할 수 있는 치킨(파닭소스 별도 제공)', price: 21000, unit: '마리', emoji: '🧅', subcategory: '오리지널', isAvailable: true },
      { id: 'ck-cheese', name: '치즈뿌리오', description: '바삭한 후라이드 위에 프리미엄급 까망베르 치즈를 뿌려 고소하고 짭조름한 치킨', price: 21000, unit: '마리', emoji: '🧀', subcategory: '스페셜', isAvailable: true },
      { id: 'ck-redspicy', name: '홍식매콤', description: '홍고추의 향과 매콤한 맛이 조화된 매력적인 치킨', price: 22000, unit: '마리', emoji: '🌶️', subcategory: '스페셜', isAvailable: true },
      { id: 'ck-honeycorn', name: '허니콘', description: '달콤한 꿀과 고소한 콘의 조화가 일품인 치킨', price: 22000, unit: '마리', emoji: '🍯', subcategory: '스페셜', isAvailable: true },
      { id: 'ck-neck', name: '꼬들목', description: '닭의 특수부위인 목살만 이용한 튀긴 요리로 식감이 쫄깃하고 꼬들꼬들하며 고소함이 일품', price: 7000, unit: '팩', emoji: '🍖', subcategory: '사이드', isAvailable: true },
      { id: 'ck-cheeseball', name: '치즈볼', description: '자연산 100% 모짜렐라 치즈 함유로 단백하고 쫄깃한 치즈볼 (5개)', price: 5000, unit: '5개', emoji: '🧀', subcategory: '사이드', isAvailable: true },
      { id: 'ck-menbosa', name: '멘보샤', description: '바삭한 식빵 사이에 새우살을 넣고 튀긴 중식 스타일 애피타이저', price: 6000, unit: '세트', emoji: '🍤', subcategory: '사이드', isAvailable: true },
    ],
  },
  {
    id: 'bakery',
